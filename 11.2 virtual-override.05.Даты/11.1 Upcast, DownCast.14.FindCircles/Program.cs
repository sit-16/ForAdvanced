namespace CSharpEsentials2dEditor
{
    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Circle firstCircle = new Circle(5, "r", -1, "d", new Point(3, 5), 4);
            Edge firstEdge = new Edge(0, "t", 5.6, "d", new Point(1, 2), new Point(5, -4));
            Polygon firstPolygon = new Polygon(3, "d", 1.7, "k", new List<Point> { new Point(1, 7), new Point(4, 5) });
            Polygon secondPolygon = new Polygon(3, "g", 6.5, "p", new List<Point> { new Point(5, 8), new Point(1, 7), new Point(4, 5) });
            Polygon thirdPolygon = new Polygon(2, "d", 6.7, "y", new List<Point> { new Point(1, -6), new Point(1, 6), new Point(5.6, 6), new Point(4, 7) });
            Polygon fourthPolygon = new Polygon(3, "d", 1.7, "k", new List<Point> { new Point(2, 3), new Point(5, 6), new Point(4, 9) });
            Edge secondEdge = new Edge(1, "f", 7.8, "r", new Point(2, 3), new Point(4, -6));
            Circle secondCircle = new Circle(89, "n", 3, "p", new Point(1, 7), 6);

            Polygon firstTriangle = FindFirstTriangle(new Figure[] { firstCircle, firstEdge, firstPolygon, secondPolygon, thirdPolygon, fourthPolygon, secondEdge, secondCircle });
        ...
        public static Polygon FindFirstTriangle(Figure[] figures)
        {
            ...
            {
                FirstTriangle = f as Polygon;
                if (FirstTriangle != null)
                    if (FirstTriangle.Points.Count == 3) return FirstTriangle;
            }
            return null;
        }
